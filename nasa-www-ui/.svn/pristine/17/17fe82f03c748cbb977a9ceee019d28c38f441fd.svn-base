...
define([
    ...
    function (ArgumentError,
        ...
        Object.defineProperties(WorldWindow.prototype, {
             ...
             * Each function is passed one argument, the current drawLocation context. The function may modify the
             * ordered renderables in the drawLocation context's ordered renderable list, which has been sorted from front
        ...
        WorldWindow.prototype.handleContextLost = function (event) {
            ...
            // Notify the drawLocation context that the WebGL rendering context has been lost.
        ...
        WorldWindow.prototype.handleContextRestored = function (event) {
            Logger.log(Logger.LEVEL_INFO, "WebGL context event: " + event.statusMessage);
            // Notify the drawLocation context that the WebGL rendering context has been restored.
        ...
        WorldWindow.prototype.doDraw = function () {
            ...
            if (this.subsurfaceMode && this.hasStencilBuffer) {
                ...
                if (!this.deferOrderedRendering) {
                    ...
                    // fragments that ordered renderables drawLocation. The terrain and surface shapes will be subsequently
         ...
         * @param {DrawContext} dc The current drawLocation context.
